            ...
            <table class="transaction-table" cellspacing="0" cellpadding="0">
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $value->qty ?></td>
                        <td style="text-align:right; width:60px"><?= indo_currency($value->detail_price) ?></td>
                        <td style="text-align:right; width:60px"><?= indo_currency(($value->detail_price - $value->discount_item) * $value->qty) ?></td>
                    </tr>
                    <?php
                ...
                <?php if ($sale->discount > 0) { ?>
                    <tr>
                        ...
                        <td style="text-align:right; padding-top:5px"><?= indo_currency($sale->discount) ?></td>
                    </tr>
                <?php } ?>
                <tr>
                    <td colspan="2"></td>
                    <td style="border-top: 1px dashed;text-align:right; padding-top:5px 0">Grand Total</td>
                    <td style="border-top: 1px dashed;text-align:right; padding-top:5px 0"><?= indo_currency($sale->final_price) ?></td>
                </tr>
                <tr>
                    <td colspan="2"></td>
