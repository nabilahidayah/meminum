...
<section class="content">
  ...
  <section class="content">
    <div class="container-fluid">
          ...
          <div class="col-lg-10">
            <form action="<?php echo base_url(); ?>dashboard/tanggalFilter" method="post">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input placeholder="YYYY-MM-DD" type="text" class="form-control datepicker" id="date1" name="tanggalAwal">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input placeholder="YYYY-MM-DD" type="text" class="form-control datepicker" id="date2" name="tanggalAkhir">
                </div>
              </div>
      ...
      <div class="card card-success">
        <div class="card-header">
          <h3 class="card-title">Filter Chart</h3>
        </div>
        <div class="card-body">
          <div class="chart">
